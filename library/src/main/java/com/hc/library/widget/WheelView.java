...
public class WheelView extends ScrollView {
    ...
    private final static int[] ATTRS = {R.attr.colorAccent};
    ...
    private void init(Context context) {
        ...
        mColorAccent = a.getColor(0, ContextCompat.getColor(getContext(),R.color.colorMain));
...
//            position = divided + offset + 1;
        ...
        for (int i = 0; i < childSize; i++) {
            ...
            if (position == i) {
                itemView.setTextColor(mColorAccent);
            } else {
                itemView.setTextColor(0xFFBBBBBB);
            }
        }
    }
