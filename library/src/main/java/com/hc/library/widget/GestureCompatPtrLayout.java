...
/**
 * Created by xc on 2016/8/25.
 */
public class GestureCompatPtrLayout extends PtrClassicFrameLayout
{
    ...
    public GestureCompatPtrLayout(Context context) {
        this(context,null);
    }

    public GestureCompatPtrLayout(Context context, AttributeSet attrs) {
        this(context, attrs,0);
    }

    public GestureCompatPtrLayout(Context context, AttributeSet attrs, int defStyle) {
