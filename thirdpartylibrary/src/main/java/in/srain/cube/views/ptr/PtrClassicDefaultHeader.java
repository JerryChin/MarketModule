...
import com.hc.thirdpartylibrary.R;
...
public class PtrClassicDefaultHeader extends FrameLayout implements PtrUIHandler {
    ...
    public void onUIRefreshComplete(PtrFrameLayout frame) {
        ...
        @StringRes int stringRes = R.string.cube_ptr_refresh_complete;

        int completeCode = frame.mCompleteCode;
        switch (completeCode) {
            case PtrFrameLayout.COMPLETE_CODE_SUCCESS:
                stringRes = R.string.cube_ptr_refresh_success;
                break;
            case  PtrFrameLayout.COMPLETE_CODE_FAIL:
                stringRes = R.string.cube_ptr_refresh_fail;
                break;
            case  PtrFrameLayout.COMPLETE_CODE_CANCEL:
                stringRes = R.string.cube_ptr_refresh_cancel;
                break;
        }

        mTitleTextView.setText(getResources().getString(stringRes));
