...
public class PtrFrameLayout extends ViewGroup {
    public final static int COMPLETE_CODE_NONE = -1;
    public final static int COMPLETE_CODE_SUCCESS = 1;
    public final static int COMPLETE_CODE_FAIL = 2;
    public final static int COMPLETE_CODE_CANCEL = 3;

    int mCompleteCode = COMPLETE_CODE_NONE;
     ...
     */
    final public void refreshComplete(int completeCode) {
    ...
    final public void refreshComplete(){
        refreshComplete(COMPLETE_CODE_NONE);
    }
